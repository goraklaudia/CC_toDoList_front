const URL = 'https://todo-list-coderscamp.herokuapp.com/api/tasks';
...
export const tasksList = async function() {
  ...
  $.get('./modules/tasks/templates/tasksList/tasksList.mst', function(
    template
  ) {
    const result = Mustache.to_html(template);
    $('.content').html(result);
...
function loadingPage() {
  ...
  fetch(`https://todo-list-coderscamp.herokuapp.com/api/projects/${userId}`)
    .then(resp => resp.json())
    .then(resp => {
